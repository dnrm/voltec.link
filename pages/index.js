    ...
    <div>
      ...
      <main className="grid grid-cols-1 gap-14 md:gap-28 z-30">
        ...
        <section id="technologies max-w-7xl mx-auto">
          ...
          <div className="technologies flex gap-8 md:gap-16 justify-center items-center px-5 py-4 md:py-10">
            <div className="nextjs w-32 text-[#e1e1e1]">
            ...
            <div className="javascript w-16 text-[#e1e1e1]">
            ...
            <div className="vercel text-[#e1e1e1] w-36">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                viewBox="0 0 284 65"
